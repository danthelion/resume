...
\begin{center}
	...
	\vspace{2mm}
	{\faEnvelope\ danivgy@gmail.com} | {\faLink\ linkedin.com/in/danthelion} | {\faLink\ github.com/danthelion}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Experience
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{cventries}
	...
	{\def\arraystretch{1.15}{\begin{tabular}{ l l }
		Data: & {\skill{ Snowflake, BigQuery, dbt, Kafka, Databricks, Redpanda, Fivetran, Materialize, ETL, ELT }} \\
		Cloud:  & {\skill{ Composer, GKE, Cloud Functions, Cloud Build, Pub/Sub, GCS, etc. }} \\
		Programming:  & {\skill{ Python (pandas, airflow, luigi, scikit, FastAPI, etc.), SQL, bash, Go, HTML/JS/CSS3 }} \\
